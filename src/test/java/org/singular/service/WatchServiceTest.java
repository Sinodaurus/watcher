...
public class WatchServiceTest {
    ...
    public void before() {
        ...
        SeenMovieDTO seenMovieDTO = new SeenMovieDTO("testMovieId");
        SeenMovie seenMovie = modelMapper.map(seenMovieDTO, SeenMovie.class);
        Mockito.when(seenMovieRepository.findByImdbMovieId("testMovieId")).thenReturn(seenMovie);
    }
